...
SAGAME.validPlayerIDs = ['test', 'test1', 'test2', 'test3', 'test4', 'test5', 'test6', 'ida1', 'ida2', 'esko1', 'esko200']; 

var clipsets_json = 'config/fl2016_clipsets_20170907.json';
var targets_json = 'config/fl2016_targets_20171014.json';

SAGAME.timeline = {'Test1' : {'start' : '2017-09-01', 'end' :'2020-09-10', 'require': 'practice'}, 
